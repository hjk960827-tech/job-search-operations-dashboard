...
export function buildUiContract({ mode = "demo" } = {}) {
  ...
  return {
    ...
    capabilities: {
      ...
      packageReviewTransitions: capability(personal, personal),
      cancelSubmissionPreparation: capability(personal, personal),
      markAllNotificationsRead: capability(personal, personal),
      outcomeEvidenceUpload: capability(personal, personal),
