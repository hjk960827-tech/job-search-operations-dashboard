...
export const DELETION_QUARANTINE_DIR = path.join(PRIVATE_DATA_DIR, ".deletion-quarantine");
export const COMPANION_DIR = path.join(PRIVATE_DATA_DIR, "companion");
export const COMPANION_TASKS_DIR = path.join(COMPANION_DIR, "tasks");
export const COLLECTION_RUNS_DIR = path.join(PRIVATE_DATA_DIR, "collection-runs");
export const READ_RUNS_DIR = path.join(PRIVATE_DATA_DIR, "read-runs");
...
export const OUTCOME_EVIDENCE_DIR = path.join(PRIVATE_DATA_DIR, "outcome-evidence");
...
export function outcomeEvidencePath(...segments) {
  return assertPathInside(OUTCOME_EVIDENCE_DIR, path.join(OUTCOME_EVIDENCE_DIR, ...segments), "outcome evidence path");
}

export function companionTaskPath(...segments) {
  return assertPathInside(COMPANION_TASKS_DIR, path.join(COMPANION_TASKS_DIR, ...segments), "companion task path");
}

export function collectionRunPath(...segments) {
  return assertPathInside(COLLECTION_RUNS_DIR, path.join(COLLECTION_RUNS_DIR, ...segments), "collection run path");
}
